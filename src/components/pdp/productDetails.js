...
import $ from 'jquery';
import shreIcon from '../../assets/images/shareIcon.png';
import { 
   FacebookShareButton, 
   TwitterShareButton,
   WhatsappShareButton,
  ...
  componentWillReceiveProps = (nextProps) => {
      if (nextProps.user_details.isUserLoggedIn) {
          if (nextProps.wishList && !nextProps.wishList.wishLoader && nextProps.wishList.addwishlist && !nextProps.wishList.removewishlist &&  nextProps.wishList.productWishDetail && nextProps.wishList.productWishDetail.is_in_wishlist
            && this.state.is_wishlist !== true && is_wishlist !== true && clickOnWishlistFlag) {
               is_wishlist = true;
               clickOnWishlistFlag = false;
            this.setState({
               is_wishlist: true,
               wishlistId: nextProps.wishList.productWishDetail.wishlist_itemid,
               Spinner: false,
            ...
            nextProps.wishList.productWishDetail = "";
         } else if(nextProps.product && nextProps.product.product && nextProps.product.product[0] && 
            nextProps.product.product[0].additional_attributes[0] &&
             nextProps.product.product[0].additional_attributes[0].is_wishlist === 1 && this.state.is_wishlist === '' &&
             clickOnWishlistFlag === false) {
               is_wishlist = true;
               this.setState({
                  is_wishlist: true,
                  wishlistId: nextProps.product.product[0].additional_attributes[0].wishlist_item_id
               });
         } else if ((
               (nextProps.wishList && !nextProps.wishList.addwishlist && nextProps.wishList.removewishlist  && nextProps.wishList.productWishDetail &&
               (nextProps.wishList.productWishDetail.is_in_wishlist ==='' || !nextProps.wishList.productWishDetail.is_in_wishlist)))
               && clickOnWishlistFlag === true && !nextProps.wishList.wishLoader ) {
               is_wishlist = false;
               clickOnWishlistFlag = false;
               this.setState({
               is_wishlist: false,
   ...
   clickOnWishlist = (product, isInWishList) => {
      clickOnWishlistFlag = true;
      if (this.props.user_details.isUserLoggedIn) {
         if (isInWishList) {
            let data = {
               "wishilistitemid": this.state.wishlistId
              }
        ...
        // this.props.history.push(location);
         // this.props.history.push(`/${this.props.store_locale}/login?product_id=${product.id}`);
      }
   }
   ...
   render() {
      ...
      return (
         <>
         {product && product.product && product.product[0] && <div>
            <ToastContainer />
            {alertBox}
                        ...
                        <div className="col-md-9 w_70">
                           ...
                           <div className="col-md-3 w_30">
                              <div className="p_Feature">
                                 {additional_attributes.labels && <span className="p_new">{additional_attributes.labels}</span>}
                                ...
                                {productData.cat_img_path && <img src={productData.cat_img_path} alt="product1" />}
                                 ...
                                 <div className="p_rewiew">
                                    <ul onClick={(e) => this.openReviewSection(e, productData)} className="list-inline main_Ul">
                                       <li className="list-inline-item">
                                          <ul className="list-inline starList">
                                             ...
                                             <img src={avgReview >= 0.5 ? starYellow : starGrey } alt="startYellow" /> </span></li>
                                             <li className="list-inline-item"><span>
                                             <img src={ avgReview >= 1.5 ? starYellow : starGrey } alt="startYellow" /></span></li>
                                             <li className="list-inline-item"><span>
                                             <img src={ avgReview >= 2.5 ? starYellow : starGrey } alt="startYellow" /></span></li>
                                             <li className="list-inline-item"><span>
                                             <img src={ avgReview >= 3.5 ? starYellow : starGrey } alt="startYellow" /></span></li>
                                             <li className="list-inline-item"><span>
                                             <img src={ avgReview === 4.5  ? starYellow : starGrey } alt="startGrey" /></span></li>
                                          </ul>
                                       </li>
                                       {this.props.reviews && this.props.reviews.list && <li className="list-inline-item">
                                          <span >
                                       ...
                                       {this.state.showProductReviewModal ?
                                          <Modal  modalId="sumitReviewModel" open={this.state.showProductReviewModal} onClose={this.closeProductReviewModal}>
                                             <div>
                                    ...
                                    <p className="p_price">
                                          <span>{productData.currency} {productData.offers.data['1']}</span>&nbsp;
                                    <span style={{ textDecoration: 'line-through' }}>
                                             &nbsp;{productData.currency} {productData.price}</span>
                                    </p>}
                                    {isOffers === false && 
                                    <p className="p_price">
                                    ...
                                    <div className="p_BuyNow">
                                       <p className={additional_attributes && additional_attributes.quantity_and_stock_status && additional_attributes.quantity_and_stock_status.is_in_stock ? 'p_aviText': 'p_outofstockText' }>
                                       {(additional_attributes && additional_attributes.quantity_and_stock_status && additional_attributes.quantity_and_stock_status.is_in_stock ) ?
                                          ...
                                          {additional_attributes.quantity_and_stock_status.is_in_stock ?
                                             <div className="col-6">
                                                <div className="QtyCounter">
                                                   ...
                                                   <img className={(quantity === 1 ? "blur " : '')} onClick={() => this.reduceQty()} src={minIcon} alt="minIcon" />
                                                   </span>
                                                   <input value={quantity} type="text" />
                                                   <span className="plus">
                                                   <img className={(parseInt(additional_attributes.quantity_and_stock_status.qty) === quantity ? "blur " : '')} onClick={(e) => this.addQty(parseInt(additional_attributes.quantity_and_stock_status.qty))} 
                                                   src={PluIcon} alt="minIcon" ></img>
                                                   </span>
                                                </div>
                                             </div> :
                                             <div>
                                             ...
                                             <div className="col-6 pd-zer0">
                                                <div className="limitDiv">
                                                   ...
                                                   {additional_attributes.quantity_and_stock_status ? additional_attributes.quantity_and_stock_status.qty : ''}</span>
                                                   <img src={info} data-tip={ this.props.globals.store_locale==='en' ? "We restrict the limit a household can buy in order to <br /> be fair to all of our fans.<br /> If you’ve already reached that limit through previous<br /> orders your order may be cancelled.": " إننا نقيد الحد الذي يمكن لكل أسرة شراءه، وذلك حتى نكون منصفين مع جميع معجبينا. فإذا وصلت لذلك الحد من خلال طلبات سابقة، فمن الممكن أن يلغى طلبك.  " } alt="minIcon" />
                                       ...
                                       <div className="addBag">
                                          ...
                                          <button className="btn-disabled" onClick={() => this.props.notifyMe(product.product[0].id)}>
                                             <FormattedMessage id="NotifyMe" defaultMessage="Notify Me" />
                                             {this.props.notifiedLoader && <i class="fa fa-spinner fa-spin ml-1 mr-1" aria-hidden="true"></i>}
                                          </button> 
                                          }
                                       </div>
                                       <div className="Ad-wishList">
                                       {this.state.is_wishlist && <svg onClick={(e) => this.clickOnWishlist(productData, true)}
                                        ...
                                        <path d="M19.986 30l.014-.014.014.014 8.223-8.116-.018-.019a5.678 5.678 0 0 0 1.78-4.126C30 14.569 27.398 12 24.187 12A5.829 5.829 0 0 0 20 13.762 5.827 5.827 0 0 0 15.815 12C12.604 12 10 14.569 10 17.739a5.68 5.68 0 0 0 1.782 4.126" fill="#006DB7"></path><path d="M26.84 20.417L20 27.204l-6.84-6.787A3.67 3.67 0 0 1 12 17.739C12 15.677 13.71 14 15.815 14a3.82 3.82 0 0 1 2.754 1.159l1.43 1.467 1.433-1.467A3.818 3.818 0 0 1 24.186 14C26.289 14 28 15.677 28 17.739a3.673 3.673 0 0 1-1.16 2.678M19.986 30l.014-.014.014.014 8.223-8.116-.018-.019a5.678 5.678 0 0 0 1.78-4.126C30 14.569 27.398 12 24.187 12A5.829 5.829 0 0 0 20 13.762 5.827 5.827 0 0 0 15.815 12C12.604 12 10 14.569 10 17.739a5.68 5.68 0 0 0 1.782 4.126" fill="#006DB7"></path></svg>}
                                          {!this.state.is_wishlist && <img onClick={(e) => this.clickOnWishlist(productData, false)} className="wishIcon" src={wishlistCircle} alt="wishlistCircle" />}
                                          <span>
                                ...
                                {productData.cat_img_path && <img src={productData.cat_img_path} alt="product1" />}
                                 ...
                                 <div className="p_rewiew">
                                    ...
                                    <div className="p_BuyNow">
                                       ...
                                       {(additional_attributes && additional_attributes.quantity_and_stock_status && additional_attributes.quantity_and_stock_status.is_in_stock ) ?
                                           <FormattedMessage id='pdp.available_Now' defaultMessage='Available now' /> :
                                       <FormattedMessage id='pdp.OutOfStock' defaultMessage='Out of stock' />}</p>
                                       <div className="p_qty">
                                          <ul className="list-inline">
                                             {additional_attributes.quantity_and_stock_status.is_in_stock ?
                                             <li className="list-inline-item">
                                                <div className="QtyCounter">
                                                   ...
                                                   <img className={(parseInt(additional_attributes.quantity_and_stock_status.qty) === quantity ? "blur " : '')} onClick={(e) => this.addQty(parseInt(additional_attributes.quantity_and_stock_status.qty))} src={PluIcon} alt="minIcon" /></span>
                                                </div>
                                             </li> :<></>}
                                             <li className="list-inline-item">
                                                <div className="limitDiv">
                                                   <span className="limit">
                                                   <FormattedMessage id='pdp.Limit' defaultMessage='Limit' /> {" "+additional_attributes.quantity_and_stock_status.qty}</span>
                                                   <img src={info} 
                                                   data-tip={ this.props.globals.store_locale==='en' ? "We restrict the limit a household can buy in order to<br /> be fair to all of our fans.<br /> If you’ve already reached that limit through previous<br /> orders your order may be cancelled.": " إننا نقيد الحد الذي يمكن لكل أسرة شراءه، وذلك حتى نكون منصفين مع جميع معجبينا. فإذا وصلت لذلك الحد من خلال طلبات سابقة، فمن الممكن أن يلغى طلبك.  "}  alt="minIcon" />
                                                   <ReactTooltip place="top" html={true}/>
                                                </div>
                                             </li>
                                          </ul>
         ...
         <div>
            <Modal
               modalId="deleteModelShareIcon"
               open={this.state.isShareIcon}
                     onClose={this.closeShareIcon}>
                  <div className="modal-body">
                        <div className="container-fluid nopadding">
