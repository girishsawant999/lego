...
import CountryCodeList from "../../components/utility/country_code"
			...
			<div id="phoneNumber" className="t-Form-itemWrapper">
				<IntlTelInput
					...
					onPhoneNumberChange={(status, value, countryData, number, id) => {
						...
						this.setState({ phone: value, dialCode: countryData.dialCode,phoneValid: status })
					...
					defaultCountry={
						CountryCodeList[this.props.defaultPhone.carrier_code]
							? CountryCodeList[this.props.defaultPhone.carrier_code].country_id
